...
export const projects: IFreeProject[] = [
  {
    ...
    technologies: [
      ...
      { icon: 'material-design', id: 2, name: 'Angular Material' },
      { icon: 'chart-line', id: 3, name: 'Chart.js' },
      { icon: 'firebase', id: 4, name: 'Firebase' },
      { icon: 'code-tags', id: 5, name: 'Puppeteer' },
    ],
    title: 'COVID-19 archive for my hometown',
  },
  {
    key: 1,
